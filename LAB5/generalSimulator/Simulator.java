...
public class Simulator {
	 ...
	 *         the static Time, we might want to have the dynamic time
	 *         as well...?
	 */
	 ...
	 * @question2 How do we even know that there is a eventlist that is made? do we create all of this in the main method?
	 * @question3 Shouldn't we just pass a new StartEvent and a StopEvent to this method?
	 */
	public void start() {
		view.startPrint();
		Event e;
